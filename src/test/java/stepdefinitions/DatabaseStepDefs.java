...
public class DatabaseStepDefs {
    ...
    @Given("user reads all of the {string} columns data")
    public void user_reads_all_of_the_columns_data(String column) throws SQLException {
    ...
    @Given("verify {string} table {string} columns contains {string} data")
    public void verify_table_columns_contains_data(String table, String column, String data) {
    ...
    public void verify_the_column_names_of_table(String table) {
        System.out.println(DBUtils.getColumnNames("select * from "+table));
    }
