...
//        registrationPage.ssnTextbox.sendKeys(string);
    ...
    @Given("user provides the password as {string} and secondPassword as {string}")
    public void user_provides_the_password_as_and_second_password_as(String string, String string2) {
